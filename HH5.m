% Hodgkin-Huxley Neuron Model Simulation with Baseline and Excitatory Pulse
clear all;
...
% Baseline applied current (0.65 nA)
baseline_current = 0.65e-9; % Baseline current (A)
...
title('Applied Current with Excitatory Pulse');
xlabel('Time (ms)');
ylabel('Current (nA)');
grid on;
