% Hodgkin-Huxley Neuron Model Simulation with Applied Current
clear all;
...
start_idx = ceil(0.1 / dt); % Start at 100 ms
end_idx = ceil(0.2 / dt);   % End at 200 ms
I_ext(start_idx:end_idx) = 0.22e-9; % 0.22 nA for 100 ms
